...
class Config(models.Model):
    name = models.CharField('Nom de configuration', max_length=30, blank=True, unique= True) #pour l'instant tout les profs on les 4 configs principales mais on devrait changer
