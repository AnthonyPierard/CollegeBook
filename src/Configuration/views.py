...
def add_default_configuration(userId):
    ...
    configCreator(
        config_name="only Seat",
        json_url="/static/json/onlySeat.json",
        user_id=userId,
        seats=basicSeats,
    )
    configCreator(
        config_name="all Seat",
        json_url="/static/json/allSeat.json",
        user_id=userId,
        seats=basicSeats,
    )
    configCreator(
        config_name="only standing",
        json_url="/static/json/onlyStanding.json",
        user_id=userId,
        seats=basicSeats,
    )
    configCreator(
        config_name="standing with bleacher",
        json_url="/static/json/standingWithBleacher.json",
        user_id=userId,
        seats=basicSeats,
    )
