...
from Event.tasks import check_event_is_archived, send_remainders_mail, send_thanks_mail, check_rep_is_archived
...
scheduler.add_job(check_rep_is_archived, CronTrigger.from_crontab('* * * * *'))
